<template>
	<footer class="bg-ink-950 text-white py-16">
		<div class="container mx-auto px-6">
			<div class="grid md:grid-cols-3 gap-12 max-w-4xl mx-auto">
				<!-- Brand -->
				<div>
					<h3
						class="text-lg font-heading font-bold tracking-wider mb-4"
					>
						KI KAI DOJO
					</h3>
					<p class="text-white/40 text-sm leading-relaxed mb-6">
						La via del karate è un percorso di crescita continua,
						fisica e spirituale.
					</p>
					<div class="flex gap-4">
						<a
							...
							class="text-white/30 hover:text-white transition-colors duration-300"
						>
							<svg
				...
				<div>
					<h3
						class="text-xs font-bold text-white/50 uppercase tracking-[0.2em] mb-4"
					>
						Navigazione
					</h3>
					<ul class="space-y-2">
						<li v-for="item in menuItems" :key="item.href">
							<a
								:href="item.href"
								class="text-white/40 text-sm hover:text-white transition-colors duration-300"
							>
								{{ item.text }}
							</a>
						</li>
				...
				<div>
					...
					<div class="space-y-2 text-white/40 text-sm">
						...
						<a
							...
							class="block hover:text-white transition-colors duration-300"
						>
							+39 349 563 0438
						</a>
						<a
